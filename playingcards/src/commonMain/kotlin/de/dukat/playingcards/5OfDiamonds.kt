...
val PlayingCards.`5OfDiamonds`: ImageVector
    get() {
        if (_5OfDiamonds != null) {
            return _5OfDiamonds!!
        }
        _5OfDiamonds = ImageVector.Builder(
            name = "5OfDiamonds",
            ...
            path(fill = SolidColor(Color(0xFFDF0000))) {
                moveToRelative(158.16f, 222.72f)
                lineToRelative(-2.95f, 0.25f)
                quadToRelative(-0.33f, -2.16f, -1.52f, -3.25f)
                quadToRelative(-1.2f, -1.08f, -2.89f, -1.08f)
                quadToRelative(-2.03f, -0f, -3.44f, 1.53f)
            ...
            path(fill = SolidColor(Color(0xFFDF0000))) {
                moveTo(90.68f, 107.24f)
                curveTo(85.2f, 99.83f, 82.28f, 92.3f, 82.28f, 92.3f)
                curveToRelative(0f, 0f, -2.92f, 7.53f, -8.39f, 14.95f)
                curveTo(68.41f, 114.65f, 61.58f, 119.47f, 61.58f, 119.47f)
                curveTo(61.58f, 119.47f, 68.41f, 124.29f, 73.89f, 131.71f)
                curveTo(79.37f, 139.12f, 82.28f, 146.65f, 82.28f, 146.65f)
                curveTo(82.28f, 146.65f, 85.2f, 139.12f, 90.68f, 131.71f)
                curveTo(96.16f, 124.29f, 102.99f, 119.47f, 102.99f, 119.47f)
                curveTo(102.99f, 119.47f, 96.16f, 114.65f, 90.68f, 107.24f)
                close()
            }
        }.build()
...
private var _5OfDiamonds: ImageVector? = null

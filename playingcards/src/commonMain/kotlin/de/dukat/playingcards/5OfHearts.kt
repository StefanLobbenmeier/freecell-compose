...
val com.dukat.playingcards.PlayingCards.`5OfHearts`: ImageVector
    get() {
        if (_root_ide_package_.com.dukat.playingcards._5OfHearts != null) {
            return _root_ide_package_.com.dukat.playingcards._5OfHearts!!
        }
        _root_ide_package_.com.dukat.playingcards._5OfHearts = ImageVector.Builder(
            name = "5OfHearts",
            ...
            path(fill = SolidColor(Color(0xFFDF0000))) {
                moveTo(93.43f, 101.64f)
                curveTo(84.42f, 101.64f, 83.21f, 110.69f, 83.21f, 110.69f)
                curveTo(83.21f, 110.69f, 82.01f, 101.64f, 73f, 101.64f)
                curveTo(66.69f, 101.64f, 60.98f, 105.7f, 60.98f, 113.35f)
                curveTo(60.98f, 123.46f, 79.26f, 133.62f, 83.21f, 148.46f)
                curveTo(86.97f, 133.63f, 105.45f, 123.46f, 105.45f, 113.35f)
                curveTo(105.45f, 105.7f, 99.74f, 101.64f, 93.43f, 101.64f)
                close()
            }
        }.build()
...
private var _5OfHearts: ImageVector? = null

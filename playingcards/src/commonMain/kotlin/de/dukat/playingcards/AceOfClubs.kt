...
val PlayingCards.AceOfClubs: ImageVector
    get() {
        if (_AceOfClubs != null) {
            return _AceOfClubs!!
        }
        _AceOfClubs = ImageVector.Builder(
            name = "AceOfClubs",
            ...
            path(fill = SolidColor(Color.Black)) {
                moveToRelative(160.51f, 214.47f)
...
private var _AceOfClubs: ImageVector? = null

...
val PlayingCards.JackOfSpades: ImageVector
    get() {
        if (_JackOfSpades != null) {
            return _JackOfSpades!!
        }
        _JackOfSpades = ImageVector.Builder(
            name = "JackOfSpades",

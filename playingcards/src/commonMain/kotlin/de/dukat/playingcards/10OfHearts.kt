...
val PlayingCards.`10OfHearts`: ImageVector
    get() {
        if (_10OfHearts != null) {
            return _10OfHearts!!
        }
        _10OfHearts = ImageVector.Builder(
            name = "10OfHearts",
            ...
            path(fill = SolidColor(Color(0xFFDF0000))) {
                moveToRelative(155.68f, 212.06f)

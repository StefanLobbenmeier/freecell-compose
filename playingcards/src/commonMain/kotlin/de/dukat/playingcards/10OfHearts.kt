...
val com.dukat.playingcards.PlayingCards.`10OfHearts`: ImageVector
    get() {
        if (_root_ide_package_.com.dukat.playingcards._10OfHearts != null) {
            return _root_ide_package_.com.dukat.playingcards._10OfHearts!!
        }
        _root_ide_package_.com.dukat.playingcards._10OfHearts = ImageVector.Builder(
            name = "10OfHearts",
            ...
            path(fill = SolidColor(Color(0xFFDF0000))) {
                moveTo(72.53f, 203.11f)
                curveTo(81.55f, 203.11f, 82.75f, 194.07f, 82.75f, 194.07f)
                curveTo(82.75f, 194.07f, 83.95f, 203.11f, 92.96f, 203.11f)
                curveTo(99.27f, 203.11f, 104.98f, 199.06f, 104.98f, 191.41f)
                curveTo(104.98f, 181.3f, 86.7f, 171.14f, 82.75f, 156.29f)
                curveTo(78.99f, 171.12f, 60.52f, 181.3f, 60.52f, 191.41f)
                curveTo(60.52f, 199.06f, 66.22f, 203.11f, 72.53f, 203.11f)
                close()
            }
        }.build()
...
private var _10OfHearts: ImageVector? = null
